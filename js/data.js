...
export const ENEMY_DB = [
    { name: '史萊姆', hp: 1500, turns: 3, personality: 'cowardly' },      // Stage 1 (Index 0)
    { name: '哥布林', hp: 3500, turns: 3, personality: 'cowardly' },      // Stage 2 (Index 1)
    { name: '巨石傀儡', hp: 8000, turns: 3, personality: 'rough' },       // Stage 3 (Index 2) Elite
    { name: '幽暗衛士', hp: 20000, turns: 3, personality: 'mysterious' }, // Stage 4 (Index 3)
    { name: '吸血鬼男爵', hp: 45000, turns: 3, personality: 'arrogant' },// Stage 5 (Index 4)
    { name: '深淵魔龍', hp: 100000, turns: 3, personality: 'beast' },     // Stage 6 (Index 5) Elite
    { name: '影焰刺客', hp: 250000, turns: 3, personality: 'mysterious' },// Stage 7 (Index 6)
    { name: '遺忘守護者', hp: 500000, turns: 3, personality: 'arrogant' },// Stage 8 (Index 7)
    { name: '虛空大祭司', hp: 900000, turns: 3, personality: 'mysterious' },// Stage 9 (Index 8) Elite
    { name: '創世神', hp: 1500000, turns: 3, personality: 'arrogant' },   // Stage 10 (Index 9) Boss
];
