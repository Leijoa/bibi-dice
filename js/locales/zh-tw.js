export const zh_tw_data = {
  ...
  rules: {
    ...
    'rule_d1': { name: '絕對秩序', desc: '八顆數字全為奇數或全為偶數' },
...
ui: {
    ...
    hand_tag_fixed: '指定數字',
    hand_tag_any: '任意數字',
    legend_same: '相同字母＝相同數字',
    legend_run: '連續字母＝連續數字',
    legend_fixed: '數字＝指定數字',
    legend_wild: '＝任意骰',
  ...
  tutorial: {
    ...
    step5: '你的骰面會同時在 A、B、C、D 四個計分區結算牌型：\n\nA 區湊相同數字、B 區湊連續順子、C 區湊複合牌型、D 區湊特殊盤面。亮起的區代表湊出了牌型，四區倍率會相乘！',
    step6: '實際點一下亮起的「A」區！\n\n你剛鎖定的 3 已經湊成「三同」——點擊計分區後，組成牌型的骰子會發光，並跳出牌型說明浮條。',
    step7: '骰子下方跳出的這條就是「牌型說明區」。\n\n這裡會顯示牌型名稱、倍率與達成條件。之後點任何亮起的計分區，說明都會出現在這裡。',
    step8: '中間的大數字是預估傷害：總基礎點數 × 四區倍率相乘的結果。\n\n左側愛心是你的 HP，被敵人反攻時會扣減。',
    step9: '史萊姆身上有紅色的「生鏽的鎖」枷鎖標籤。\n\n請點擊這個枷鎖標籤，查看本場戰鬥的特殊限制。',
    step10: '畫面中央跳出的這個視窗就是「枷鎖說明」。\n\n之後隨時點敵人身上的枷鎖標籤，都能再次查看本場戰鬥的限制。',
