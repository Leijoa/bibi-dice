...
- 關卡進度、通關、失敗與無限塔進度
- 選擇的遺物、消耗品、牌型與升級項目
- 戰鬥結果、傷害區間、失敗原因與遊戲平衡相關統計
- 遊戲版本、語言設定、作業系統與基本裝置資訊
- 錯誤、當機或效能診斷資訊

本遊戲不會為遊玩分析目的主動收集以下資料：
...
本遊戲不以兒童為主要目標，也不會故意收集兒童的個人資料。若開發者得知已不慎收集兒童個人資料，將採取合理方式刪除相關資料。

### 9. 隱私政策更新

本政策可能因遊戲功能、Steamworks 功能、分析工具或法律要求而更新。更新後會在公開頁面標示新的「最後更新」日期。
...
- Stage progress, clears, failures, and Infinite Tower progress
- Selected relics, consumables, hands, and upgrades
- Battle results, damage ranges, failure reasons, and balance-related statistics
- Game version, language setting, operating system, and basic device information
- Error, crash, or performance diagnostics

The game will not intentionally collect the following for gameplay analytics:

- Real names
- Addresses
- Government ID numbers or ID images
...
This game is not primarily directed at children and does not knowingly collect personal data from children. If the developer learns that children's personal data has been collected unintentionally, reasonable steps will be taken to delete that data.

### 9. Updates

This policy may be updated due to changes in game features, Steamworks features, analytics tools, or legal requirements. The public page will show a new "Last Updated" date when the policy is updated.

---

## 待更新事項 / Future Updates

- [x] 補上公開聯絡信箱。
- [ ] 若正式版實作 Steam 成就、雲端存檔、排行榜、分析或當機回報，發布前再次更新本政策。
- [ ] 若未來加入第三方分析、當機回報或雲端服務，啟用前補上服務名稱與資料處理說明。
