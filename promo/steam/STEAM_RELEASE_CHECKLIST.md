...
- [x] 6 張桌面直式截圖排序合理，涵蓋：標題畫面、戰鬥中、牌型預覽、商店遺物、Boss 枷鎖、靈魂奉獻
  - 備註：2026-05-24 已用 `npm.cmd run steam:capture` 重產 6 張反映最新版 UI（emoji 移除、新鎖定骰視覺、商店融合流程修正後），製作人同日目視確認全部通過、可作為 Steam 商店頁素材使用。實際主題：#1 標題、#2 戰鬥開局、#3 牌型「比比丟八」八同爆發、#4 牌型倍率表（B-04 製作人決定保留，**已確認保留，不需替換**）、#5 商店遺物、#6 靈魂奉獻。
- [x] 6 張截圖確認適合全年齡顯示（無血腥、無成人內容）
  - 備註：2026-05-24 製作人已目視確認 6 張可用：無血腥、無暴力、無成人內容、無賭博視覺；版面置中、文字無截斷、無 UI 跑版、無彈窗出界。
